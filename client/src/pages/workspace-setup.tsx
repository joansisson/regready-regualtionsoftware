...
function mapExistingToQuestionnaire(existing: WorkspaceProfile | null): ComplianceQuestionnaireState {
  ...
  const timeToRevokeTarget = accessControl?.timeToRevokeOffboarding as ComplianceQuestionnaireState["timeToRevokeTarget"] | undefined;
        ...
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <Card>
            <CardHeader className="space-y-1">
              ...
              <CardDescription>These answers help RegReady produce more precise, auditor-ready remediation steps.</CardDescription>
            </CardHeader>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setDataRetentionPolicyDuration(e.target.value ? e.target.value : undefined)}
